  ...
  return (
    <div className="">
      <div className=" relative mt-[5rem]">
       <div><div className="bg-green-500 w-1 h-1 shadow-[0_0_5px_5px_rgba(240,240,240,0.3)] rounded-full -top-[1rem] left-[4rem] absolute"></div>
      ...
      {/* desc */}
        <div className="border-b border-zinc-50/30 text-gray-300 mx-auto w-full px-[5rem] text-left pb-[1rem] text-sm mt-[2rem]">
