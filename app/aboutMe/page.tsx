    ...
    <div className={`${poppins.className}`}>
      <div className=" relative mt-[7rem]">
       <div><div className="bg-green-500 w-1 h-1 shadow-[0_0_5px_5px_rgba(240,240,240,0.3)] rounded-full -top-[1rem] md:left-[22rem] left-[4rem] absolute animate-pulse"></div>
        ...
        <div className="text-white font-semibold hover:text-black hover:bg-white border border-zinc-50 w-[14rem] md:w-[10rem] h-[3rem] mx-auto mt-[4rem] rounded-3xl flex justify-center items-center gap-[1rem] md:mt-0 transition-colors duration-500 ">
        <FaGithub size={27}/>
        Github
        </div>
        <div className="border border-zinc-50 text-white font-semibold hover:text-black hover:bg-white w-[14rem] md:w-[10rem] h-[3rem] mx-auto mt-[1.5rem] md:mt-0 rounded-3xl flex justify-center items-center gap-[1rem] transition-colors duration-500">
        <FaXTwitter size={25} />
        Twitter
        </div>
        <div className="text-white font-semibold hover:text-black hover:bg-white border border-zinc-50 w-[14rem] md:w-[10rem] h-[3rem] mx-auto mt-[1.5rem] rounded-3xl flex justify-center items-center gap-[1rem] transition-colors duration-500 md:mt-0"><FaLinkedinIn size={18} /> LinkedIn</div>
        <div className="text-white font-semibold hover:text-black hover:bg-white border border-zinc-50 w-[14rem] md:w-[10rem] h-[3rem] mx-auto mt-[1.5rem] rounded-3xl flex justify-center items-center gap-[1rem] transition-colors duration-500 md:mt-0">    <SiLeetcode />Leetcode</div>
        </div>
      {/* desc */}
